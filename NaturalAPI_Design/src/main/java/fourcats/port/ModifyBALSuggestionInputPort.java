...
public interface ModifyBALSuggestionInputPort {
    ...
    void modifyActionName(int idAction, int idScenario, String newName,boolean isBdlLoaded);
    ...
    void modifyObjectName(int idAction, int idScenario, int idObject, String newName,boolean isBdlLoaded);
